...
export default function CSVUpload({ onUploadComplete }: CSVUploadProps) {
  ...
  const [uploadResults, setUploadResults] = useState<CSVUploadResponse | null>(
    null,
  );
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Upload a CSV file with semicolon (;) separator. Format:
      ...
      <details className="mt-4">
        ...
        <div className="mt-2 p-4 bg-gray-50 rounded-md text-sm text-gray-700">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              <strong>Separator:</strong> Use semicolon (;) to separate columns
            </li>
            <li>
              <strong>Required fields:</strong> title, url, category
            </li>
            <li>
              <strong>Optional fields:</strong> description, author
            </li>
            <li>
              <strong>Header row:</strong> First row can be headers (will be
              skipped if it contains &quot;title&quot;)
            </li>
            <li>
              <strong>Empty fields:</strong> Leave empty between semicolons for
              optional fields
            </li>
          </ul>
        </div>
